...
{
    private const string ServiceName = "Account.Api";
    ...
    public static IServiceCollection AddAccountObservability(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    public static ILoggingBuilder AddAccountObservability(this ILoggingBuilder logging, IConfiguration configuration)
    {
        var otlpEndpoint = GetOtlpEndpoint(configuration);
